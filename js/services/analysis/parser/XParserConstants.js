...
export class ParserConstants {
    ...
    */
    QUALIFICATION_SUBFILTERS = [
        ...
        {
            target: "personal",
            anyOf: ["zuverlässig", "strukturiert", "teamfähig", "kommunikations", "eigenständig", "motiviert", "unterschiedlichen stärken", "team lebt von","du begeisterst","werde teil","gestaltest du","deine expertise"]
        },
        {
            target: "required",
            anyOf: ["erfolg","abgeschlossene ausbildung","berufserfahrung","expertenwissen","du verfügst","sehr gute","überzeugst du","bestens vertraut","studium"]
        }    
    ];
    ...
    */
    BENEFIT_TAGS = [
        ...
        { term: "weiterbildung", label: "Fortbildung" },
        { term: "fortbildung", label: "Fortbildung" },
        { term: "betriebsarzt", label: "Betriebsarzt" },
        { term: "firmenwagen", label: "Firmenwagen" },
        { term: "flexible arbeitszeit", label: "Flexible Arbeitszeiten" },
    ...
    */
    JOB_TAG_WHERE = [
        ...
        {term: "vor ort", label: "Vor Ort"},
    ]

    JOB_TAG_WHAT = [
        {term: "vollzeit", label: "Vollzeit"},
        {term: "teilzeit", label: "Teilzeit"},
        {term: "minijob", label: "Minijob"},
        {term: "Werkstudent", label: "Werkstudent"},
        {term: "Praktikum", label: "Praktikum"},
        {term: "Freelance", label: "Freelance"},
    ]

    JOB_TAG_HOW = [
        {term: "Befristet", label: "Befristet"},
        {term: "Unbefristet", label: "Unbefristet"},
    ]

    //Überschreifeten Teiler
    SEARCH_HELPERS = {    
        Karriere: [
            "karriere",
            "jobs",
    ...
    APPLICATION_TYPE = [
        {term: "bewerbung online", label: "Online"},
        {term: "per mail", label: "Mail"},
        {term: "per posrt", label: "Brief"},
        {term: "per whatsappposrt", label: "WhatsApp"},
    ]

    IMPORTANT_APPLICATION_INFORMATION = {
        allOf: [
            ["können","nicht akzeptieren"],
            ["datenschutzgründe"]
        ]
    }
    ...
    static TAGS = {
        ...
        "TecS-Stack": [
            "HTML","CSS","Deutsch","JavaScript","Vue 3","responsive Design", "API-Anbindung", "Statemangaement", "Mocks", "Unit-Test","UC","GTM","GA4",
            "Azure","DevOps","CI/CD","Git","GitHub","Bitbucket","AWS","GCP","Azure","Kubernetes","Docker","Terraform","Ansible","Jenkins","CircleCI","TravisCI",
            "Gitlab","Gitea","GitHub","Bitbucket Server","Jira","Confluence","Trello","Asana","Slack","Discord","MS Teams","Zoom","Google Meet","Microsoft Teams",
            "Google Calendar","Microsoft Calendar","Google Drive","Microsoft Drive","Google Docs","Microsoft Docs","Gmail","Outlook","Yahoo Mail","Protonmail",
            "C#", "C-Sharp"

        ],

        "IT": [
            "product owner","scrum master","scrum","agile","kanban","lean","devops","testautomation","automatisierung","software development","software engineering",
        ] 
    }
